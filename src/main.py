...
from file_picker import chooseImagePath, chooseImagePathRef, listOfPaths

from color import color, print_image, print_images
from boxBuilder import *
from kdTree import doKDtree
from payloadKps import *
...
def myPrintKeyDiff(imgL, imgR, imgLKps, imgRKps):
    ...
    # print_image(newimg, name='Non cleaned matches')
    ...
    print_image(newimg, name='Cleaned matches')
